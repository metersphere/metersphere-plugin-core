...
public class UiScript {
    ...
    public UiScript(String id, String name, String clazzName, String script, String option) {
        this.id = id;
        this.name = name;
        this.clazzName = clazzName;
        this.formScript = script;
    ...
    public UiScript(String id, String name, String clazzName, String jmeterClazz, String script, String option) {
        this.id = id;
        this.name = name;
        this.clazzName = clazzName;
